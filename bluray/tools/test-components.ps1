...
foreach ($name in @('bluray-compatibility','bluray-opening-settings','iso-routing','lav-menu-bridge','lav-mpeg2-stills','lav-navigation-timestamps','navigation-commands','navigation-display')) {
